...
public class Player {
    ...
    public Vector3 Scale { get { return gameObject.transform.localScale; } set { gameObject.transform.localScale = value; playerController.scaleDirty = true; if (IsLocal) { ScaleGameManager.Inst.UpdateEnvironment(); playerController.DisableHeadLookAt(); } } }
