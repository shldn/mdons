...
public class ReceiveLSL : MonoBehaviour {
	...
	void Update(){
        //targetRotation += new Vector3(rotationX, rotationY, 0f);
        //float smoothTime = 0.2f;
        //Vector3 tempRot = transform.eulerAngles;
        //tempRot.x = Mathf.SmoothDampAngle(tempRot.x, targetRotation.x, ref rotVel.x, smoothTime);
        //tempRot.y = Mathf.SmoothDampAngle(tempRot.y, targetRotation.y, ref rotVel.y, smoothTime);
        //tempRot.z = Mathf.SmoothDampAngle(tempRot.z, targetRotation.z, ref rotVel.z, smoothTime);
