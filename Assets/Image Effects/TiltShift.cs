...
public class TiltShift : PostEffectsBase
{
	...
	{	
		...
		if (enableForegroundBlur)
		{
			...
			{
				tiltShiftMaterial.SetVector ("offsets", new Vector4 (0.0f, (maxBlurSpread * 0.75f) * oneOverBaseSize, 0.0f, 0.0f));	
				Graphics.Blit (lrTex1, lrTex2, tiltShiftMaterial, 3); 
				tiltShiftMaterial.SetVector ("offsets", new Vector4 ((maxBlurSpread * 0.75f / widthOverHeight) * oneOverBaseSize, 0.0f, 0.0f, 0.0f));	
		...
		{
			tiltShiftMaterial.SetVector ("offsets", new Vector4 (0.0f, (maxBlurSpread * 1.0f) * oneOverBaseSize, 0.0f, 0.0f));	
			Graphics.Blit (lrTex2, lrTex1, tiltShiftMaterial, 6); 
			tiltShiftMaterial.SetVector ("offsets", new Vector4 ((maxBlurSpread * 1.0f / widthOverHeight) * oneOverBaseSize, 0.0f, 0.0f, 0.0f));	
